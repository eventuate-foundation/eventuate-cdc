...
./gradlew $* :eventuate-local-java-cdc-connector-polling:cleanTest :eventuate-local-java-cdc-connector-polling:test -Dtest.single=PollingCdcProcessorEventsTest
